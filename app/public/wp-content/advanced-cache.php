...
// WP-Optimize advanced-cache.php (written by version: 4.5.5) (homeurl: http://northeastern-research.local/) (abspath: /Users/darshanaswathappa/Local Sites/northeastern-research/app/public/) (do not change this line, it is used for correctness checks)
...
$possible_plugin_locations = array(
	...
	'/Users/darshanaswathappa/Local Sites/northeastern-research/app/public/wp-content/plugins/wp-optimize/cache',
);
...
if (false === $plugin_location) {
	...
	if (strcasecmp('http://northeastern-research.local/', $protocol . '://' . $host . $request_uri) === 0) {
